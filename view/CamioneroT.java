    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        try {
            if (jTextField6.getText().isEmpty()) {
                JOptionPane.showMessageDialog(null, "Tiene que introducir un DNI", "Error", JOptionPane.WARNING_MESSAGE);
            } else if (validarDNI(jTextField6.getText()) == false) {
                JOptionPane.showMessageDialog(null, "Introduzca un DNI válido", "Error", JOptionPane.WARNING_MESSAGE);
            } else {
