...
public class ControladorPaquete {
    ...
    public static TableModelPaquete getT3() {
     ...
     public static void insertarPaquete(int nCodigo, String nDescripcion, String nDestinatario, String nDireccion, String nFecha, String nDni_Camionero, int nCod_Provincia) throws SQLException {
         TableModelPaquete.insertarPaquete(nCodigo, nDescripcion,  nDestinatario, nDireccion,nFecha, nDni_Camionero, nCod_Provincia);
    }
